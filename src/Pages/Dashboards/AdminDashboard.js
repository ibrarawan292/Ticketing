...
const AdminDashboard = () => {
  ...
  const AdminLogout = () => {
    ...
    fetch(ApiURL + "/AdminLogout", requestOptions)
            ...
            >
              ...
              <span className={ShrinkMenu === true ? "hidden" : "space-y-5"}>
                ...
                <NavLink
                  ...
                  to="manage-events"
                >
                  <BsCalendar2Event size="1.3em" className="mr-3 self-center" />
                  <div className="flex w-full">
                    <div className="text-[13px] self-center font-light cursor-pointer">
                      Manage Events
                    </div>
                ...
                <NavLink
                  ...
                  to="manage-clubs"
                >
                  <FaCcDinersClub size="1.3em" className="mr-3 self-center" />
                  <div className="flex w-full">
                    <div className="text-[13px] self-center font-light cursor-pointer">
                      Manage Clubs
                    </div>
                ...
                <NavLink
                  ...
                  to="manage-family"
                >
                  <MdFamilyRestroom size="1.3em" className="mr-3 self-center" />
                  <div className="flex w-full">
                    <div className="text-[13px] self-center font-light cursor-pointer">
                      Manage Family
                    </div>
              ...
              >
                ...
                <div className="container h-screen space-y-5 pt-14 pb-3 flex flex-col">
                  ...
                  <NavLink
                    ...
                    to="manage-plans"
                  >
                    <MdOutlineAddTask className="mr-3 self-center" />
                  ...
                  <NavLink
                    ...
                    to="manage-users"
                  >
                    <FaUserFriends className="mr-3 self-center" />
                  ...
                  <NavLink
                    ...
                    to="manage-Reviews"
                  >
                    <MdOutlineRateReview className="mr-3 self-center" />
                  ...
                  <NavLink
                    ...
                    className="py-4 w-full text-2xl flex justify-center text-gray-800 "
                    to="messages"
                  >
